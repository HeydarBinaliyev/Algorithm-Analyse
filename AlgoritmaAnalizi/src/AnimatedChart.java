...
public class AnimatedChart extends Applet {
  ...
  public AnimatedChart(double[] _data){
	  this._data=_data;
  }
  ...
  private GraphicsPlotCanvas createPlotCanvas() {
    ...
    props.put("plot/coordinateSystem/yAxis/axisLabel", "hit rate");
    props.put("plot/coordinateSystem/yAxis/maximum", "300");
  ...
  public void ciz(double[] _data){
	    ...
	    Applet applet = new AnimatedChart(_data);
	    applet.init();
	    frame.add(applet);
